...
<body>
	...
	<div class="wrap">
		...
		<input type="hidden" id="PAGE_INDEX" name="PAGE_INDEX" /> <br /> <a
			href="#this" class="btn" id="create">글쓰기</a>
		...
		function fn_selectBoardListCallback(data) {
			...
			if (total == 0) {
				...
				$.each(data.list, function(key, value) {
					str += "<tr>" + "<td>" + value.NOTICE_IDX + "</td>"

					+ "<td>" + "<a href='#first' name='trigger'>"
					...
					/* 	
						...
						+ value.NOTICE_SUBJECT
						+ "</a>"
						+ "<input type='hidden' id='NOTICE_IDX' name='title' value=" 
                            				+ value.NOTICE_IDX + ">"
						+ "</td>" 
