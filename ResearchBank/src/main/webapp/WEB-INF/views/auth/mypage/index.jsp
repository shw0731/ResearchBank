...
<br/><br/><br/><br/>
           ...
           <p style="font-size:25px;"> 회원 정보</p><p style="font-size:13px;">Research Bank는 회원님의 개인정보를 신중히 취급하며, 회원님의 동의 없이는 기재하신 회원정보가 공개되지 않습니다.
            </p>
            <hr/><br/>  
             </div>
...
<table class="type01">
    ...
    <tr>
        <td><a href="/refundmylist.do">포인트 환전 내역</a><br/>
        	<a href="/refundmylist.do">나의 계좌 정보</a>
        </td>
    </tr>
</table>
</div>
               ...
               <table class="type05"
                        id="dataTables-example" style="align:center;width:40%;">
              ${MEMBER_NICKNAME}님의 Research Bank<a href="updateMember" class="btn" >수정하기</a>
                      ...
                      <tr>
                        <td>포인트</td>
                        <td>: ${map.MEMBER_POINT}<a href="/refund.do" class="btn"><span>환전하기</span> </a> </td>
                      </tr>                  
                      <tr>
                        <td>성별</td>
