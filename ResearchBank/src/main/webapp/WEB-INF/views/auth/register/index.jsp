			...
			<table class="board_list">
				...
				<td>
					...
					<td>
						...
						<input type="text" id="member_id" class="form-control" name="member_id" placeholder="이메일 주소">
						<input type="button" class="btn btn-danger btn-send-message"  value="중복확인"	onclick="duplicationId();" />
						</div>
						</div>
						<td></td>
					</tr>
					...
					<td>
						...
						<div class="form-group">
						<div class="input-group-append">	
						<input type="password" id="member_pw" class="form-control" name="member_pw" placeholder="비밀번호">
						</div>
						</div>
						<td></td>
					</tr>
					...
					<td>
						...
						<div class="form-group">
						<div class="input-group-append">	
						<input type="password" class="form-control" id="member_repw" name="member_repw" placeholder="비밀번호를 다시 한번 입력하세요">
						</div>
						</div>
						<td></td>
					</tr>
					<tr>
						...
						<div class="form-group">
						<div class="input-group-append">	
						<input type="text" class="form-control" id="member_nickname"	name="member_nickname" placeholder="닉네임을 입력하세요">
					    <input type="button" class="btn btn-danger btn-send-message" value="중복확인" onclick="duplicationNickname();"  >
						</div></div>
						<td></td>
				...
				<tfoot>
					<tr>
						...
						<br/>
						<br/>
						<button type="button" class="btn btn-primary btn-xl" value="회원가입" onclick="DosignUp();" >회원가입</button>
					</tr> 
					</td>
									<!-- 약관부분 -->
				<thead align="center" valign=middle>
					...
					<tr> 
						<td colspan="3">
						<!-- 폼양식 --><!-- 약관파일 가져오기 --> 
						<textarea cols="70" rows="7" readonly="readonly"> 
							<%@ include file="/WEB-INF/views/auth/register/terms.txt"%> </textarea></td>
					</tr>
					<tr>
						<td colspan="3" align="right"><input type="checkbox" name="agree" id="agree" value="" />
							약관에 동의합니다.</td>
